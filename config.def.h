...
static const char *DEFAULT_FONT       = "victor mono";
...
static const keymap_t keys[] = {
	...
	{ 0,            XK_semicolon,     g_quit,               0 },
	{ 0,            XK_e,             g_switch_mode,        None },
	{ 0,            XK_space,         g_toggle_image_mark,  None },
	{ ShiftMask,    XK_space,         g_pick_quit,          0 },
	...
	{ ControlMask,  XK_a,             g_scroll_screen,      DIR_UP },
	{ ControlMask,  XK_i,             g_scroll_screen,      DIR_DOWN },
	{ ControlMask,  XK_o,             g_scroll_screen,      DIR_RIGHT },

	{ 0,            XK_n,             t_move_sel,           DIR_LEFT },
	{ 0,            XK_a,             t_move_sel,           DIR_UP },
	{ 0,            XK_i,             t_move_sel,           DIR_DOWN },
	{ 0,            XK_o,             t_move_sel,           DIR_RIGHT },

	{ 0,            XK_n,             i_scroll,             DIR_LEFT },
	{ 0,            XK_a,             i_scroll,             DIR_UP },
	{ 0,            XK_i,             i_scroll,             DIR_DOWN },
	{ 0,            XK_o,             i_scroll,             DIR_RIGHT },

	{ 0,            XK_N,             i_scroll_to_edge,     DIR_LEFT },
	{ 0,            XK_A,             i_scroll_to_edge,     DIR_UP },
	{ 0,            XK_I,             i_scroll_to_edge,     DIR_DOWN },
